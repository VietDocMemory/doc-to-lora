...
def lora_forward(
    ...
    **kwargs,
    ...
    # Preserve specialized implementations such as bitsandbytes Linear4bit.
    # patch_lora_forward stores the original bound method before wrapping it.
    base_out = self.forward_orig(x, *args, **kwargs)
    x = x.to(A.dtype)
